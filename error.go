...
func UnaryErrorDeterminer(determiner ErrorDeterminer) grpc.UnaryServerInterceptor {
...
func StreamErrorDeterminer(determiner ErrorDeterminer) grpc.StreamServerInterceptor {
